...
def get_fvalue(val):
	"""Function to encode the feature value from label dictionary
...
def get_value(val,my_dict):
	"""This function will encode gender map dictionary item
...
def load_model(model_file):
	"""This function will load model using joblib
...
def run_ml_app():
	"""Machine learning model is loaded and data points are passed through each attribute
