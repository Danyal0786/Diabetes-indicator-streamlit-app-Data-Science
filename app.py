...
# ---------------------------------------------------------------------------------------
#Setting up page title, layout and icon
st.set_page_config(
    page_title="Diabetes Predictor App",
    page_icon=":pill:",
	layout="wide",
...
def main():
	""" Main function which contains application layout and screens
		and also we call eda and ml function from another .py files 
	"""
	...
	if choice == "Home":
		...
		st.subheader("About")
		st.text("Diabetes Indicator streamlit application")
